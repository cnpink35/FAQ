...
function view(element) {
            ...
            if (content.style.display != 'none') {      
                ...
                $(this).find(".qMark").find("img").attr('src', q.attr('src').replace('_op.png', '.png'));
                $(this).find(".click").find("img").attr('src', arrow.attr('src').replace('up_arrow.jpg', 'down_arrow.png'));
              ...
              document.getElementsByClassName("click").src="down_arrow.png";*/
                ...
                $(this).find(".qMark").find("img").attr('src', q.attr('src').replace('.png', '_op.png'));
                $(this).find(".click").find("img").attr('src', arrow.attr('src').replace('down_arrow.png', 'up_arrow.jpg'));
